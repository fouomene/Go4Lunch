...
public class ConnectionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        facebookLogin = findViewById(R.id.connection_activity_facebook_login);
...
/*
    ...
    AuthMethodPickerLayout customLayout = new AuthMethodPickerLayout
            ...
            .setFacebookButtonId(R.id.connection_activity_facebook_login)
            .setGoogleButtonId(R.id.connection_activity_google_login)
            .build();
*/
